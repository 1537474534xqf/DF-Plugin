...
export default async function(path, params, cfg = {}) {
  ...
  const data = {
    ...
    sys: {
      ...
      copyright: `Created By ${Version.name}<span class="version">v${Version.yunzai}</span> & ${Plugin_Name}<span class="version">v${Version.ver}</span><br>Licensed under <span class="version">GPL-3.0</span>`
    },
    quality: 100
  }
